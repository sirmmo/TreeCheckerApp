...
export const SLIDE_DATA = [
  ...
  text: 'Once you have selected an area, you will enter in the Map View. Here you can navigate through the map and explore all the observations available in the area. And also, you can check and edit your own observations by pressing on them.',

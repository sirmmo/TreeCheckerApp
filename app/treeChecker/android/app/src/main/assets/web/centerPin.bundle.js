...
"use strict";
var _reactNativeWebviewMessaging=__webpack_require__(1);var _reactNativeWebviewMessaging2=_interopRequireDefault(_reactNativeWebviewMessaging);var _layerDefinitions=__webpack_require__(3);var _layerDefinitions2=_interopRequireDefault(_layerDefinitions);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_reactNativeWebviewMessaging2.default.on('json',function(json){receiveWebViewMessages(json);});function sendDataToReact(data){_reactNativeWebviewMessaging2.default.sendJSON(data);};var mymap=L.map('mapid');mymap.on('load',function(e){initLayers();addMapEvents();});setTimeout(function(){sendDataToReact({"webInit":true});},3000);function receiveWebViewMessages(json){if(json.pos){mymap.setView([json.pos.latitude,json.pos.longitude],17);}else if(json.urlOffline){addOfflineLayers(json.urlOffline);}};function initLayers(){var osm=new L.TileLayer(_layerDefinitions2.default.osm.url,{maxZoom:19,attribution:_layerDefinitions2.default.osm.attribution});mymap.addLayer(osm);}function addOfflineLayers(baseURL){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=_layerDefinitions2.default.downloadables[typeof Symbol==='function'?Symbol.iterator:'@@iterator'](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var layerName=_step.value;console.log("Adding "+layerName);var layer=new L.TileLayer(baseURL+'/tiles/'+layerName+'/{z}/{x}/{y}.png',{maxZoom:17});mymap.addLayer(layer);}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}}function addMapEvents(){mymap.on('moveend',function(e){sendDataToReact({"center":mymap.getCenter()});});}
